...
skippable replay, reloading to the gate, a "no code?" capture); all three were rejected. The concern is
retained in full at [`backlog/epic-02-gated-flow/02.4.md`](../backlog/epic-02-gated-flow/02.4.md) rather
than dropped, so the trade is visible if signup numbers later come in low.
...
From [Epic 02](../backlog/epic-02-gated-flow/README.md), story
[02.4](../backlog/epic-02-gated-flow/02.4.md).
...
email** and gets its own visible ending rather than a silent no-op
([02.6](../backlog/epic-02-gated-flow/02.6.md), [02.7](../backlog/epic-02-gated-flow/02.7.md)). Second,
the opening animation is paid for on every single visit, which is a hard constraint on its length —
scene 1 must stay short, and must yield immediately to a visitor who scrolls
([02.3](../backlog/epic-02-gated-flow/02.3.md)). Any future proposal to persist state contradicts this
PDR directly. From [Epic 02](../backlog/epic-02-gated-flow/README.md), story
[02.1](../backlog/epic-02-gated-flow/02.1.md).
...
**Consequence.** Every scene story owns its reduced-motion behavior, and [Epic 03](../backlog/epic-03-brand-motion/README.md)
dresses **both** choreographies — a reduced-motion visitor gets the full brand, just calmer motion, and
this PDR is not a licence to ship them a plainer identity. From
[Epic 02](../backlog/epic-02-gated-flow/README.md), story
[02.2](../backlog/epic-02-gated-flow/02.2.md).
...
**Consequence.** The scaffolding is built in Epic 02 ([02.8](../backlog/epic-02-gated-flow/02.8.md)) and
proven against real choreography with realistic-length placeholder copy in both languages — not lorem
ipsum, which would conceal exactly the wrapping and timing problems it exists to surface. Final wording
arrives in [Epic 03](../backlog/epic-03-brand-motion/README.md) through that same scaffolding, in both
languages together. Validation and error messages are localized too. From
[Epic 02](../backlog/epic-02-gated-flow/README.md), story
[02.8](../backlog/epic-02-gated-flow/02.8.md).
